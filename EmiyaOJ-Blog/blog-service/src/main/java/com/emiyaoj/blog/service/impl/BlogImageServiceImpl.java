...
public class BlogImageServiceImpl implements IBlogImageService {
    ...
    public BlogPictureVO upload(MultipartFile file, Long userId) {
        ...
        String objectName = "blog/%d/%s/%s.%s".formatted(
        ...
        try {
            ...
            log.error("upload blog image to MinIO failed, endpoint={}, bucket={}, objectName={}",
    ...
    public ResponseEntity<InputStreamResource> download(Long pictureId) {
        ...
        try {
            ...
            log.error("download blog image from MinIO failed, pictureId={}", pictureId, e);
    ...
    public boolean delete(Long pictureId, Long userId) {
        ...
        try {
            ...
            log.warn("remove blog image from MinIO failed, objectName={}", picture.getObjectName(), e);
        }
        picture.setDeleted(1);
        return blogPictureMapper.updateById(picture) == 1;
    }
    ...
    private BlogPicture selectActivePicture(Long pictureId) {
        BlogPicture picture = blogPictureMapper.selectById(pictureId);
